    ...
    var users = []
        ...
        , configuration = { 'iceServers': [ { 'url': 'stun:stun.l.google.com:19302' } ,
                            {
                                'url': 'turn:23.251.138.189:3478?transport=udp',
                                'credential': '9j0H4urSICko9IPF3l2pakquzK0=',
                                'username': '1442317793:41784574'
                            },
                            {
                                'url': 'turn:23.251.138.189:3478?transport=tcp',
                                'credential': '9j0H4urSICko9IPF3l2pakquzK0=',
                                'username': '1442317793:41784574'
                            } ,
                            {
                                'url': 'turn:23.251.138.189:3479?transport=udp',
                                'credential': '9j0H4urSICko9IPF3l2pakquzK0=',
                                'username': '1442317793:41784574'
                            } ,
                            {
                                'url': 'turn:23.251.138.189:3479?transport=tcp',
                                'credential': '9j0H4urSICko9IPF3l2pakquzK0=',
                                'username': '1442317793:41784574'
                            } ,
                         ]
    ...
    function receiveStreamCb(rstream, destID) {
        ...
        $('#test').append("<video id='remote-video"+destID+"' autoplay></video></div>");
